 ...
 */
class Semaglutide_Glycine extends Helper_Abstract_Config_Settings implements Helper_Interface_Config {
	...
	public function configuration() {
		return [
			...
			'fields' => [
                ...
                'order_form_glycine' => [
                    'id'         => 'order_form_glycine',
                    'name'       => esc_html__( 'Glycine', 'gravity-forms-pdf-extended' ),
                    'type'       => 'text',
                    'inputClass' => 'merge-tag-support mt-hide_all_fields',
                ],
                
                'order_form_glycine_options' => [
                    'id'         => 'order_form_glycine_options',
                    'name'       => esc_html__( 'Glycine Options', 'gravity-forms-pdf-extended' ),
                    'type'       => 'text',
                    'inputClass' => 'merge-tag-support mt-hide_all_fields',
                ],
                
                'order_form_glycine_other' => [
                    'id'         => 'order_form_glycine_other',
                    'name'       => esc_html__( 'Glycine Other', 'gravity-forms-pdf-extended' ),
                    'type'       => 'text',
                    'inputClass' => 'merge-tag-support mt-hide_all_fields',
                ],
