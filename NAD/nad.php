...
$nad_100_option_1 = $gform->process_tags( $settings['order_form_nad_100_option_1'] ?? '', $form, $entry );
$nad_100_option_2 = $gform->process_tags( $settings['order_form_nad_100_option_2'] ?? '', $form, $entry );
$nad_100_option_3 = $gform->process_tags( $settings['order_form_nad_100_option_3'] ?? '', $form, $entry );
$nad_100_quantity            = $gform->process_tags( $settings['order_form_nad_100_quantity'] ?? '', $form, $entry );
$nad_100_refill            = $gform->process_tags( $settings['order_form_nad_100_refill'] ?? '', $form, $entry );
$nad_100_sig            = $gform->process_tags( $settings['order_form_nad_100_sig'] ?? '', $form, $entry );

$nad_topical_option_1 = $gform->process_tags( $settings['order_form_nad_topical_option_1'] ?? '', $form, $entry );
$nad_topical_option_2 = $gform->process_tags( $settings['order_form_nad_topical_option_2'] ?? '', $form, $entry );
$nad_topical_option_3 = $gform->process_tags( $settings['order_form_nad_topical_option_3'] ?? '', $form, $entry );
$nad_topical_quantity            = $gform->process_tags( $settings['order_form_nad_topical_quantity'] ?? '', $form, $entry );
$nad_topical_refill            = $gform->process_tags( $settings['order_form_nad_topical_refill'] ?? '', $form, $entry );
$nad_topical_sig            = $gform->process_tags( $settings['order_form_nad_topical_sig'] ?? '', $form, $entry );

$nad_200_option_1 = $gform->process_tags( $settings['order_form_nad_200_option_1'] ?? '', $form, $entry );
$nad_200_option_2 = $gform->process_tags( $settings['order_form_nad_200_option_2'] ?? '', $form, $entry );
$nad_200_option_3 = $gform->process_tags( $settings['order_form_nad_200_option_3'] ?? '', $form, $entry );
$nad_200_quantity            = $gform->process_tags( $settings['order_form_nad_200_quantity'] ?? '', $form, $entry );
$nad_200_refill            = $gform->process_tags( $settings['order_form_nad_200_refill'] ?? '', $form, $entry );
$nad_200_sig            = $gform->process_tags( $settings['order_form_nad_200_sig'] ?? '', $form, $entry );

$nad_rdt_option_1 = $gform->process_tags( $settings['order_form_nad_rdt_option_1'] ?? '', $form, $entry );
$nad_rdt_option_2 = $gform->process_tags( $settings['order_form_nad_rdt_option_2'] ?? '', $form, $entry );
$nad_rdt_option_3 = $gform->process_tags( $settings['order_form_nad_rdt_option_3'] ?? '', $form, $entry );
$nad_rdt_quantity            = $gform->process_tags( $settings['order_form_nad_rdt_quantity'] ?? '', $form, $entry );
$nad_rdt_refill            = $gform->process_tags( $settings['order_form_nad_rdt_refill'] ?? '', $form, $entry );
$nad_rdt_sig            = $gform->process_tags( $settings['order_form_nad_rdt_sig'] ?? '', $form, $entry );

$nad_nasal_option_1 = $gform->process_tags( $settings['order_form_nad_nasal_option_1'] ?? '', $form, $entry );
$nad_nasal_option_2 = $gform->process_tags( $settings['order_form_nad_nasal_option_2'] ?? '', $form, $entry );
$nad_nasal_option_3 = $gform->process_tags( $settings['order_form_nad_nasal_option_3'] ?? '', $form, $entry );
$nad_nasal_quantity            = $gform->process_tags( $settings['order_form_nad_nasal_quantity'] ?? '', $form, $entry );
$nad_nasal_refill            = $gform->process_tags( $settings['order_form_nad_nasal_refill'] ?? '', $form, $entry );
$nad_nasal_sig            = $gform->process_tags( $settings['order_form_nad_nasal_sig'] ?? '', $form, $entry );

$nad_lollipop_option_1 = $gform->process_tags( $settings['order_form_nad_lollipop_option_1'] ?? '', $form, $entry );
$nad_lollipop_option_2 = $gform->process_tags( $settings['order_form_nad_lollipop_option_2'] ?? '', $form, $entry );
$nad_lollipop_option_3 = $gform->process_tags( $settings['order_form_nad_lollipop_option_3'] ?? '', $form, $entry );
$nad_lollipop_quantity            = $gform->process_tags( $settings['order_form_nad_lollipop_quantity'] ?? '', $form, $entry );
$nad_lollipop_refill            = $gform->process_tags( $settings['order_form_nad_lollipop_refill'] ?? '', $form, $entry );
$nad_lollipop_sig            = $gform->process_tags( $settings['order_form_nad_lollipop_sig'] ?? '', $form, $entry );
...
<table style="width: 100%; border-collapse: collapse;">
    ...
    <tr>
        <td style="width: 45%; font-weight: bold;">NAD+ 100 MG/ML Sterile Solution for IV</td>
        <td style="width: 10%;">&nbsp;</td>
        <td style="width: 45%; font-weight: bold;">NAD+ Topical Cream</td>
    </tr>
    <tr style="height:50px;">
        <td style="width: 50%;"><span class="box"><?= $nad_100_option_1 ? '&#10004;' : '&nbsp;&nbsp;&nbsp;' ?></span>&nbsp; 5 ML</td>
        <td style="width: 10%;"></td>
        <td style="width: 50%;"><span class="box"><?= $nad_topical_option_1 ? '&#10004;' : '&nbsp;&nbsp;&nbsp;' ?></span>&nbsp; 100 MG/G</td>
    </tr>
    <tr style="height:50px;">
        <td style="width: 50%;"><span class="box"><?= $nad_100_option_2 ? '&#10004;' : '&nbsp;&nbsp;&nbsp;' ?></span>&nbsp; 10 ML</td>
        <td style="width: 10%;"></td>
        <td style="width: 50%;"><span class="box"><?= $nad_topical_option_2 ? '&#10004;' : '&nbsp;&nbsp;&nbsp;' ?></span>&nbsp; 200 MG/G</td>
    </tr>
    <tr style="height:50px;">
        <td style="width: 50%;"><span class="box"><?= $nad_100_option_3 ? '&#10004;' : '&nbsp;&nbsp;&nbsp;' ?></span>&nbsp; Vial</td>
        <td style="width: 10%;"></td>
        <td style="width: 50%;"><span class="box"><?= $nad_topical_option_3 ? '&#10004;' : '&nbsp;&nbsp;&nbsp;' ?></span>&nbsp; In Anhydrous Gel</td>
    </tr>
    <tr>
        <td style="width: 45%; height: 30px;">
            Qty: <span class="underline">&nbsp;&nbsp;<?php echo esc_html( $nad_100_quantity ) ?>&nbsp;&nbsp;</span> &nbsp;&nbsp;&nbsp;&nbsp;
            Refill: <span class="underline">&nbsp;&nbsp;<?php echo esc_html( $nad_100_refill ) ?>&nbsp;&nbsp;</span>
        </td>
        <td style="width: 10%;"></td>
        <td style="width: 45%; height: 30px;">
            Qty: <span class="underline">&nbsp;&nbsp;<?= $nad_topical_quantity ?>&nbsp;&nbsp;</span> &nbsp;&nbsp;&nbsp;&nbsp;
            Refill: <span class="underline">&nbsp;&nbsp;<?php echo esc_html( $nad_topical_refill ) ?>&nbsp;&nbsp;</span>
        </td>
    </tr>
    <tr>
        <td style="width: 45%;">Sig: <span class="underline">&nbsp;&nbsp;<?php echo esc_html( $nad_100_sig ) ?>&nbsp;&nbsp;</span></td>
        <td style="width: 10%;"></td>
        <td style="width: 45%;">Sig: <span class="underline">&nbsp;&nbsp;<?php echo esc_html( $nad_topical_sig ) ?>&nbsp;&nbsp;</span></td>
    </tr>
    <tr>
    ...
    <tr>
        <td style="width: 45%; font-weight: bold;">NAD+ 200 MG/ML for Subcutaneous Injection</td>
        <td style="width: 10%;">&nbsp;</td>
        <td style="width: 45%; font-weight: bold;">NAD+ RDT</td>
    </tr>
    <tr style="height:50px;">
        <td style="width: 50%;"><span class="box"><?= $nad_200_option_1 ? '&#10004;' : '&nbsp;&nbsp;&nbsp;' ?></span>&nbsp; 5 ML Vial</td>
        <td style="width: 10%;"></td>
        <td style="width: 50%;"><span class="box"><?= $nad_rdt_option_1 ? '&#10004;' : '&nbsp;&nbsp;&nbsp;' ?></span>&nbsp; 100 MG</td>
    </tr>
    <tr style="height:50px;">
        <td style="width: 50%;"></td>
        <td style="width: 10%;"></td>
        <td style="width: 50%;"><span class="box"><?= $nad_rdt_option_2 ? '&#10004;' : '&nbsp;&nbsp;&nbsp;' ?></span>&nbsp; 200 MG</td>
    </tr>
    <tr>
        <td style="width: 45%; height: 30px;">
            Qty: <span class="underline">&nbsp;&nbsp;<?php echo esc_html( $nad_200_quantity ) ?>&nbsp;&nbsp;</span> &nbsp;&nbsp;&nbsp;&nbsp;
            Refill: <span class="underline">&nbsp;&nbsp;<?php echo esc_html( $nad_200_refill ) ?>&nbsp;&nbsp;</span>
        </td>
        <td style="width: 10%;"></td>
        <td style="width: 45%; height: 30px;">
            Qty: <span class="underline">&nbsp;&nbsp;<?= $nad_rdt_quantity ?>&nbsp;&nbsp;</span> &nbsp;&nbsp;&nbsp;&nbsp;
            Refill: <span class="underline">&nbsp;&nbsp;<?php echo esc_html( $nad_rdt_refill ) ?>&nbsp;&nbsp;</span>
        </td>
    </tr>
    <tr>
        <td style="width: 45%;">Sig: <span class="underline">&nbsp;&nbsp;<?php echo esc_html( $nad_200_sig ) ?>&nbsp;&nbsp;</span></td>
        <td style="width: 10%;"></td>
        <td style="width: 45%;">Sig: <span class="underline">&nbsp;&nbsp;<?php echo esc_html( $nad_rdt_sig ) ?>&nbsp;&nbsp;</span></td>
    </tr>
    <tr>
        <td style="width: 45%; height: 45px;">&nbsp;</td>
        <td style="width: 10%;">&nbsp;</td>
    ...
    <tr>
        <td style="width: 45%; font-weight: bold;">NAD+ Nasal Spray</td>
        <td style="width: 10%;">&nbsp;</td>
        <td style="width: 45%; font-weight: bold;">NAD+ 200 MG Lollipop</td>
    </tr>
    <tr style="height:50px;">
        <td style="width: 50%;"><span class="box"><?= $nad_nasal_option_1 ? '&#10004;' : '&nbsp;&nbsp;&nbsp;' ?></span>&nbsp; 100 MG/ML</td>
        <td style="width: 10%;"></td>
        <td style="width: 50%;"><span class="box"><?= $nad_lollipop_option_1 ? '&#10004;' : '&nbsp;&nbsp;&nbsp;' ?></span>&nbsp; Lollipop</td>
    </tr>
    <tr style="height:50px;">
        <td style="width: 50%;"><span class="box"><?= $nad_nasal_option_2 ? '&#10004;' : '&nbsp;&nbsp;&nbsp;' ?></span>&nbsp; 200 MG/ML</td>
        <td style="width: 10%;"></td>
        <td style="width: 50%;"></td>
    </tr>
    <tr>
        <td style="width: 45%; height: 30px;">
            Qty: <span class="underline">&nbsp;&nbsp;<?php echo esc_html( $nad_nasal_quantity ) ?>&nbsp;&nbsp;</span> &nbsp;&nbsp;&nbsp;&nbsp;
            Refill: <span class="underline">&nbsp;&nbsp;<?php echo esc_html( $nad_nasal_refill ) ?>&nbsp;&nbsp;</span>
        </td>
        <td style="width: 10%;"></td>
        <td style="width: 45%; height: 30px;">
            Qty: <span class="underline">&nbsp;&nbsp;<?= $nad_lollipop_quantity ?>&nbsp;&nbsp;</span> &nbsp;&nbsp;&nbsp;&nbsp;
            Refill: <span class="underline">&nbsp;&nbsp;<?php echo esc_html( $nad_lollipop_refill ) ?>&nbsp;&nbsp;</span>
        </td>
    </tr>
    <tr>
        <td style="width: 45%;">Sig: <span class="underline">&nbsp;&nbsp;<?php echo esc_html( $nad_nasal_sig ) ?>&nbsp;&nbsp;</span></td>
        <td style="width: 10%;"></td>
        <td style="width: 45%;">Sig: <span class="underline">&nbsp;&nbsp;<?php echo esc_html( $nad_lollipop_sig ) ?>&nbsp;&nbsp;</span></td>
    </tr>
